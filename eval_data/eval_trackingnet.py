...
def eval_trackingnet_tune(result_path, json_path):
    list_path = json_path
...
if __name__ == "__main__":
    ...
    result_path = '/new_local_storage/zaveri/code/SiamABC/trackingnet_penalty_k_0_4650_w_influence_0_1290_lr_0_0880'
    json_path = '/new_local_storage/zaveri/SOTA_Tracking_datasets/trackingnet/trackingnet.json'
    print(eval_trackingnet_tune(result_path, json_path))
