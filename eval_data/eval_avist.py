...
if __name__ == "__main__":
    ...
    result_path = '/new_local_storage/zaveri/code/experiments/2024-07-09-14-23-02_Tracking_SiamABC/SiamABC_lambda_0.25_contineous_True/results/AVIST/SiamABCTracker'
