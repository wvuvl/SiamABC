...
def eval_dtb70_tune(result_path, json_path):
    list_path = json_path
...
if __name__ == "__main__":
    ...
    result_path = '/new_local_storage/zaveri/code/SiamABC/dtb70_penalty_k_0_4650_w_influence_0_1290_lr_0_0880'
    json_path = '/new_local_storage/zaveri/SOTA_Tracking_datasets/dtb70/dtb70.json'
    print(eval_dtb70_tune(result_path, json_path))
