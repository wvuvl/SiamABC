...
Modified from
Main Author of this file: STARK
Repo: https://github.com/researchmm/Stark/tree/main
File: https://github.com/researchmm/Stark/blob/main/lib/models/stark/resnet.py
