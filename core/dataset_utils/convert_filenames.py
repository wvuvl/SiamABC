...
path = '/new_local_storage/zaveri/code/SiamABC_cross_att/core/dataset_utils/train_csvs'
d_path = '/new_local_storage/zaveri/code/SiamABC_cross_att/core/dataset_utils/train_csvs_vulcan'

for i in tqdm(os.listdir(path)):
    csv_path = os.path.join(path,i)
    new_csv_path = os.path.join(d_path,i)
    convert_filenames(csv_path, '/new_local_storage/', '/luna_data/', new_csv_path)
