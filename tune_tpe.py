...
from eval_SiamABC import auc_otb, eao_vot, auc_got10k, auc_lasot, auc_nfs, auc_uav123, auc_avist
...
def get_tracker(config_path, config_name, weights_path, penalty_k, window_influence, lr) -> AEVTTracker:
    with open('/new_local_storage/zaveri/code/SiamABC/core/config/tracker/siam_tracker.yaml', 'r') as file:
...
def main():
    ...
    algo = HyperOptSearch(metric="AUC", mode="max")
    ...
    df.to_csv(args.dataset+'_runs.csv')
